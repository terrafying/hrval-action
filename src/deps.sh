...
curl -sL https://github.com/mikefarah/yq/releases/download/3.3.2/yq_linux_amd64 -o /usr/local/bin/yq && chmod +x /usr/local/bin/yq
...
helmv3 plugin install https://github.com/hypnoglow/helm-s3.git --version 0.9.2
